...
const AdminHome = () => {
  ...
  return (
    <div className="w-full bg-[#083149] min-h-screen mt-16 md:mt-20 items-center justify-center text-white">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 px-5 gap-x-5 mt-8 gap-y-5">
        <div className="bg-[#125E8A]  py-5 rounded flex flex-col gap-8 p-4">
  ...
  {/* <!-- First Container --> */}
  <div className=" bg-[#125E8A] rounded text-white pr-5 pb-12 pt-0 pl-1 md:col-span-2 h-[35vh] col-span-1 row-span-1">
  <p className="text-2xl font-bold text-white mb-2 mt-2 ml-5 ">Donations</p>
  <BarChartDashboard data={data}/>
   </div> 

  {/* <!-- Second Container --> */}
  <div className="col-span-1 bg-[#125E8A] rounded  h-[70vh] md:row-span-2 row-span-1">
  ...
  {/* <!-- Third Container --> */}
  <div className="md:col-span-2 bg-[#125E8A] pb-14 px-5 rounded col-span-1 h-[33vh]  row-span-1">
